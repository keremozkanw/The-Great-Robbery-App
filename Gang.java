...
public class Gang {
    ...
    private boolean isSuccesfullRobbery(){
        int randomNumber = randomNumberGenerator.nextInt(101);
        int summerizedSuccessChange = criminals.length * Criminal.SUCCESS_PERCENTAGE;
        if (randomNumber >= summerizedSuccessChange){
            return false;
        }else{
            return true;
        }
